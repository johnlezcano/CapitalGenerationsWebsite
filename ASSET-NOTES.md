...
The complete ZIP also contains a sibling folder named `private-source-assets`. That folder is intentionally outside the deployable website because the raw screenshots and proposal may contain client identifiers, proposal pricing, meeting details, and performance data.

Do not copy that sibling folder into `public/` or `dist/`.

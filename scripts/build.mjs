...
async function build() {
  ...
  const notFoundPage = {
    ...
    description: 'The requested Capital Generations page could not be found. Return home, explore services, or book a sales strategy conversation.',
    noIndex: true,
    body: `<section class="page-hero section section--dark"><div class="page-hero__glow" aria-hidden="true"></div><div class="container"><div class="page-hero__grid"><div class="page-hero__content reveal is-visible">${eyebrow('404', 'light')}<h1>That page is not here.</h1><p class="page-hero__lead">The link may be outdated, or the page may have moved during the Capital Generations website rebuild.</p><div class="button-row">${primaryButton('Return home', '/')}${secondaryButton('Explore services', '/services', { className: 'button--on-dark' })}</div></div><div class="page-hero__visual reveal is-visible"><div class="contact-visual"><div class="contact-visual__calendar"><strong>Find the next step</strong><span>Home, services, results, or a conversation</span><div><i></i><i></i><i></i><i></i><i></i></div></div></div></div></div></div></section>${ctaBand({ title: 'Still looking for something specific?', description: 'Book a conversation and tell us what you need from your sales team.', primaryHref: site.calendlyUrl })}`,
  };
